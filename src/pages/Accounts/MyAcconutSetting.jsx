      ...
      <>
          ...
          <div>
              <section>
                  <div className="container">
                      <div className="row pt-10">
                        <div className="d-lg-none mb-3 d-flex justify-content-end">
                            <button
                                              ...
                                              <div className="pe-lg-14">
                                                  ...
                                                  <form className=" row row-cols-1 row-cols-lg-2">
                                                      ...
                                                      <div className="col-12">
                                                          <p className="mb-4">
                                                              Joriy parolingizni eslolmadingizmi?
                                                              <Link to="#"> Reset your parol.</Link>
                                                          </p>
              ...
              >
                  ...
                  {/* offcanvas body */}
                  <AccountNavbarOffCanvas currentActive={currentActive} />
              </div>
          </div>
      </>
    </div>
